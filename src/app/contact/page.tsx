          ...
          <div className="max-w-2xl w-full mx-auto text-center relative z-10 flex items-center justify-center h-full">
            <div className="glass-card p-10 md:p-14 rounded-3xl shadow-2xl backdrop-blur-lg bg-white/10 border border-[var(--border)] mb-10 animate-fade-in w-full flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 mb-8">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/gal-halifa-544311333" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-3 hover:scale-110 transition-transform">
                  ...
                  <span className="text-sm text-[var(--text-secondary)]">/in/Gal Halifa</span>
                </a>
                {/* GitHub */}
                <a href="https://github.com/GalHalifa6" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-3 hover:scale-110 transition-transform">
                  ...
                  <span className="text-sm text-[var(--text-secondary)]">GalHalifa6</span>
                </a>
              </div>
